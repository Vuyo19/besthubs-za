...
export const SelectProduct: React.FC<SelectProductProps> = ({ item, addImageToState, 
    ...
    useEffect(() => {
        // Checking if the product is created. 
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-1 overflow-y-auto border-b-[1.2px] 
    border-slate-200 items-center p-2">
        {/* Checkbox for the product */}
